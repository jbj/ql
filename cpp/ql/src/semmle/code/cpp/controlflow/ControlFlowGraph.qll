...
/**
 * Purpose:
 * 1. Be convertible to Expr etc., like ControlFlowNode;
 * 2. Have no member predicates so it can be used as a base class without
 *    being modified or adding predicates to classes.
 */
